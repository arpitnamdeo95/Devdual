...
import GameStatRow from "./game_stat_table";
import LeaderboardEntryRow from "./leaderboard_entry_table";
import MatchLogRow from "./match_log_table";
...
const reducersSchema = __reducers(
  __reducerSchema("create_or_update_user", CreateOrUpdateUserReducer),
  __reducerSchema("end_match", EndMatchReducer),
  __reducerSchema("grant_badge", GrantBadgeReducer),
  __reducerSchema("record_stat", RecordStatReducer),
);
